...
return (
	<div className="min-h-[calc(100dvh-56px)] flex flex-col items-center justify-center bg-mono-800 text-white">
      ...
      >
        ...
        />
        <button type="submit" className="bg-mint-500 text-mono-900 px-4 py-2 mt-4 w-3/4 sm:w-sm cursor-pointer rounded-sm transition-transform ease-in-out duration-300 active:scale-95 hover:bg-mint-700 hover:text-mono-100">
			Sign Up
        </button>
